...
from cpcbru import *
from cpcbdu import *
from centraldu import *
from centralru import *
...
class CENTRALUpload(Thread):
    def run(self):
        print("CENTRAL Upload Thread Starts")
        while True:
            try:
                centralrumain()
            except:
                print("Exception in CENTRAL Realtime upload")
            try:
                centraldumain()
            except:
                print("Exception in CENTRAL Delayed upload")

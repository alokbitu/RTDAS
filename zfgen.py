...
def collect_data():
    ...
    try:
        # response = "+04.363+04.366+04.432+25.000+00.000+00.000+00.000+00.000"
...
def create_rawdata():
    ...
    for param in range(no_of_params):
        d0 = str("{:.4f}".format(sum_value[param], 4))
    ...
    for i in range(0, no_of_params):
        d0 = str("{:.4f}".format(sum_value[i], 4))
